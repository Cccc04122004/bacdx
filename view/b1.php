                                ...
                                <div class="p-5">
                                    ...
                                    <div class="row mb-4 d-flex justify-content-between align-items-center">
                                        <div class="col-md-2 col-lg-2 col-xl-2">
                                            <img src="https://bizweb.dktcdn.net/100/414/728/products/5-4-e25eb73a-1779-4ded-a53a-90594fe87c4a.jpg?v=1695699917960"
                                    ...
                                    <div class="pt-5">
                                        <h6 class="mb-0"><a href=".." class="text-body"><i
                                                    class="fas fa-long-arrow-alt-left me-2"></i>Trở lại trang bán
                                                hàng</a></h6>
                                    </div>
                                </div>
                            </div>
                  ...
                  <div class="mb-4 pb-2">
                    <select class="select">
                      ...
                      <option value="4">Four</option>
                                    ...
                                    <a href="http://localhost/duan1_nhom8-main/views/checkout.php">
                                        <button type="button" class="btn btn-dark btn-block btn-lg"
                                            data-mdb-ripple-color="dark">Tạo</button>
                                    </a>
